...
module.exports = {
  ...
  installInto: expect => {
    ...
    expect.addAssertion(
      '<MongooseModel|MongooseDocument> to [exhaustively] satisfy <object>',
      (expect, subject, value) => {
    ...
    expect.addAssertion(
      '<MongooseValidationError> to [exhaustively] satisfy <object>',
      (expect, subject, value) => {
    ...
    expect.addAssertion(
      '<MongooseValidatorError> to [exhaustively] satisfy <object>',
      (expect, subject, value) => {
        return expect(
    ...
    expect.addAssertion(
      '<MongooseModel|array> [when] refreshed <assertion?>',
      (expect, subject) => {
